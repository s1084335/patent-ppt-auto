...
def _minimal_content() -> dict:
    ...
    return {
        ...
        "read_me": ["怎麼讀", "第 {chart_first} 頁起為圖表"],
        "chart_rule": ["圖表原則", "圖表一律等比縮放"],
        "rec_title": "建議", "rec_takeaway": "測試",
        "recommendations": [
            {"title": "甲", "tag": "t", "lines": ["a"], "color": "cyan"},
            {"title": "乙", "tag": "t", "lines": ["a"], "color": "blue"},
            {"title": "丙", "tag": "t", "lines": ["a"], "color": "amber"},
            {"title": "丁", "tag": "t", "lines": ["a"], "color": "rose"},
        ],
        "pages": [],
