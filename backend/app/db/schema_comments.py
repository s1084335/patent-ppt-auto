...
COMMENTS: dict[str, dict[str, str]] = {
    ...
    "derived_layer.company_aliases": {
        ...
        "id": "對照編號",
        "申請人代碼": "WIPS 標準專利權人/申請人代碼；尚無 WIPS 代碼者掛 TEMP: 前綴的臨時代碼（系統標記，非 WIPS 給的代碼）",
        "公司名稱": "（舊欄，2026-07-28 四欄拆分後淡出）原本混用中文與英文正式名，保留供對照",
        "公司中文名稱": "中文正式名（顯示第一順位）；查無市場慣用中文名時留空",
        "正規化名稱": "英文正式名（顯示第二順位，中文欄空時採用）",
        "別稱": "對應到同一公司的名稱變體",
        "source_file": "來源檔案",
        "imported_at": "匯入時間",
