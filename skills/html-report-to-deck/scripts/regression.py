...
def _content() -> dict:
    ...
    return {
        ...
        "read_me": ["本簡報怎麼讀", "結論在第 2 頁；第 {chart_first}–{chart_last} 頁逐頁交代依據；第 {last} 頁收斂為行動。"],
        "chart_rule": ["圖表原則", "{n_charts} 張圖各用一次；素材為合成，不含任何真實報表。"],
        "rec_title": "四類方向：2 個機會區、1 個差異化區、1 個迴避區",
        "rec_takeaway": "本頁測試建議卡的兩行文字與標籤是否溢出。",
        "recommendations": [
            {"title": f"{c}　合成主題", "tag": t, "color": col,
             "lines": ["情報依據：11 件 5 家、近期集中度 88.9%，是最擠的一區。",
